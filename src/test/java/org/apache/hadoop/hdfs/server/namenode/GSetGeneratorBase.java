...
public abstract class GSetGeneratorBase {
    ...
    protected static final INodeDirectory root = new INodeDirectory(0, "/root".getBytes(CHARSET),
            status, now);
    ...
    public GSet<INode, INodeWithAdditionalFields> getGSet(short depth, int numDirsPerDepth, int numFilesPerDir) {
    ...
    protected abstract void generateGSet(GSet<INode, INodeWithAdditionalFields> newGSet,
                                         INodeDirectory parent,
                                         int filesPerDir,
                                         int numOfDirsPerDepth,
                                         short depth) throws IOException;

    protected abstract void generateFilesForDirectory(GSet<INode, INodeWithAdditionalFields> newGSet,
                                                      INodeDirectory parent,
