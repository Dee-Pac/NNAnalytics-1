...
/**
 * NNA utilizes a common ancestory discovery algorithm from {@link VirtualINodeTree}
 * as an optimization for analyzing specific sets of directories.
 *
 * This test is a simple demonstration of finding common ancestors to run queries against
 * so that NNA can quickly re-iterate the query on children rather than start over every time.
 */
