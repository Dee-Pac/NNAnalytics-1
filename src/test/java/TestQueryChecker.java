...
public class TestQueryChecker {
  ...
  public static HashMap<NNAConstants.SET, HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>>> getInvalidCombinations() {
    HashMap<NNAConstants.SET, HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>>> invalidCombination =
        new HashMap<>();
    //For 'File' set Type
    HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>> fileSumTypeFilterCombo = new HashMap<>();
    EnumSet<NNAConstants.SUM> diffFilesDirs = NNAConstants
        .getDifference(NNAConstants.SUM_DIR, NNAConstants.SUM_FILE);
    ...
    for (NNAConstants.SUM sum : diffFilesDirs) {
      ...
      EnumSet<NNAConstants.FILTER> onlyDir = NNAConstants
          .getDifference(NNAConstants.FILTER_DIR, NNAConstants.FILTER_ALL);
    ...
    //For 'Dir' set type
    HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>> dirSumTypeFilterCombo = new HashMap<>();
    EnumSet<NNAConstants.SUM> diffDirsFiles = NNAConstants
        .getDifference(NNAConstants.SUM_FILE, NNAConstants.SUM_DIR);
    //For Each value in 'SUM_FILE'
    for (NNAConstants.SUM sum : diffDirsFiles) {
      HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>> typeFilterCombo = new HashMap<>();
      EnumSet<NNAConstants.FILTER> onlyFile = NNAConstants
          .getDifference(NNAConstants.FILTER_FILE, NNAConstants.FILTER_ALL);
    ...
    //For 'All' set type
    HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>> allSumTypeFilterCombo = new HashMap<>();
    EnumSet<NNAConstants.SUM> sumFiles = NNAConstants
        .getDifference(NNAConstants.SUM_FILE, NNAConstants.SUM_ALL);
    //For Each value in 'SUM_FILE'
  ...
  public static HashMap<NNAConstants.SET, HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>>> getValidCombinations() {
    HashMap<NNAConstants.SET, HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>>> validCombination =
        new HashMap<>();
    //For 'File' set Type
    HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>> fileSumTypeFilterCombo = new HashMap<>();
    //For Each value in 'SUM_FILE'
  ...
  public void testValidQueryChecker() throws Exception {
    HashMap<NNAConstants.SET, HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>>> setSumTypeFilterConfig = getValidCombinations();
    String[] parameters = new String[4];
    for (NNAConstants.SET set : NNAConstants.SET.values()) {
      String setType = set.toString();
      parameters[0] = setType;
      HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>> sumTypeFilters = setSumTypeFilterConfig
          .get(set);
      for (Map.Entry<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>> sumTypeFilter : sumTypeFilters
          .entrySet()) {
        HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>> typeFilters = sumTypeFilter
            .getValue();
        String sum = sumTypeFilter.getKey();
        parameters[1] = sum;
        for (Map.Entry<String, ArrayList<EnumSet<NNAConstants.FILTER>>> typeFilter : typeFilters
            .entrySet()) {
  ...
  public void testInvalidQueryChecker() throws Exception {
    HashMap<NNAConstants.SET, HashMap<String, HashMap<String, ArrayList<EnumSet<NNAConstants.FILTER>>>>> setSumTypeFilterConfig = getInvalidCombinations();
    String[] parameters = new String[4];
    for (NNAConstants.SET set : NNAConstants.SET.values()) {
      String setType = set.toString();
      parameters[0] = setType;
